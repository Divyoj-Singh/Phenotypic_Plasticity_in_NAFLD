...
path_to_list_of_topo_files="./../list_of_topo_files/list_of_topo_files.txt"
path_to_topo_file_folder="./../topo_files/"
path_to_RACIPE_output_folder="/media/csb/D/NAFLD2/Perturbation/RACIPE/"
...
#################################	
	...
	for variable in {1..3} ### the RUN index 
		do
			...
			$path_to_RACIPE $network_identifier.topo -num_paras $num_of_parameters -seed $variable -num_stability 4 & 
