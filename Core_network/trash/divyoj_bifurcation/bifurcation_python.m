...
%% output file:
path_to_fractions_file='./matlab_output/fraction_for_015.txt';
header=["bifurcation_parameter","steady_state"];
...
for bifurcation_parameter=0.0001:0.02:0.5
...
parfor j=1:3%no_of_initial_conditions
...
% elseif (x(end,1)< th_1) && (x(end,3)<th_3) 
%     ind = 4; 
steady_state=[steady_state,(x(end,3))];
 end
% 
% s1(ind) = 1;
% state = [state; s1];
...
printing_array=[bifurcation_parameter,steady_state];
