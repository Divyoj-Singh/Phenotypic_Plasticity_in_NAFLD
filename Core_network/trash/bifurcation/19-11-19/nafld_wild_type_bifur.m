...
k_PPARG = 0.001;%0.07670399999999999;  %% #% 0.06     0.11 to 0.26
k_SREBF1 = 0.15984530000000001; %% #% 0.1732

%Thresholds
x_HNF4A_HNF4A = 2.3;%7.445485000000001;
x_SREBF1_SREBF1 = 5.25; %4.6490279999999995;     
x_PPARG_PPARG = 1%2.32011;  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
x_HNF1A_HNF1A = 0.29;     %15.796237;        

x_SREBF1_HNF4A = 5; %7.067421;                         %-----------------------------fixed for now
x_HNF1A_PPARG = 0.29%0.8740759999999998;

x_HNF4A_HNF1A = 2.3;%5.108258999999999;
x_HNF1A_HNF4A = 0.29; %14.169678;             -----------------------------fixed for now
x_SREBF1_PPARG = 1.75;%5.25; %2.6013288;               -----------------
x_PPARG_SREBF1 = 1.28398;

x_I_PPARG = 10;

% Lambdas
l_HNF4A_HNF4A = 6; %2; %%4.738871;                       --------------------
l_PPARG_PPARG = 7;%9.514515;
l_SREBF1_SREBF1 = 4; %2;%1.302063;  %%#% 2           --------------------
l_HNF1A_HNF1A = 4; %%4.3344629999999995;

l_HNF4A_HNF1A = 9;%5.328115;
l_HNF1A_HNF4A = 4; %7.737933; %%#% 3-4               ---------------------
l_SREBF1_PPARG =  3;%3;% 6.512859;      %%#% 3          ---------------fixed for now
l_PPARG_SREBF1 = 3.7292400000000003;    %%#% 3-6       ------------- fixed for now

l_SREBF1_HNF4A = 0.02;%0.415335;  %%#% 0.4-0.5             --------------------- fixed for now
