...
H_HNF4A_HNF4A=hill(protein_array(1),x_HNF4A_HNF4A,l_HNF4A_HNF4A,n_HNF4A_HNF4A);
H_HNF1A_HNF4A=hill(protein_array(2),x_HNF1A_HNF4A,l_HNF1A_HNF4A,n_HNF1A_HNF4A);
H_HNF4A_HNF1A=hill(protein_array(1),x_HNF4A_HNF1A,l_HNF4A_HNF1A,n_HNF4A_HNF1A);
H_HNF1A_HNF1A=hill(protein_array(2),x_HNF1A_HNF1A,l_HNF1A_HNF1A,n_HNF1A_HNF1A);

H_SREBF1_HNF4A=hill(protein_array(4),x_SREBF1_HNF4A,l_SREBF1_HNF4A,n_SREBF1_HNF4A);
H_HNF1A_PPARG=hill(protein_array(2),x_HNF1A_PPARG,l_HNF1A_PPARG,n_HNF1A_PPARG);

H_PPARG_PPARG=hill(protein_array(3),x_PPARG_PPARG,l_PPARG_PPARG,n_PPARG_PPARG);
H_SREBF1_PPARG=hill(protein_array(4),x_SREBF1_PPARG,l_SREBF1_PPARG,n_SREBF1_PPARG);
H_PPARG_SREBF1=hill(protein_array(3),x_PPARG_SREBF1,l_PPARG_SREBF1,n_PPARG_SREBF1);
H_SREBF1_SREBF1=hill(protein_array(4),x_SREBF1_SREBF1,l_SREBF1_SREBF1,n_SREBF1_SREBF1);

H_INPUT_PPARG=hill(I,x_I_PPARG,l_I_PPARG,n_I_PPARG);
...
dydt=[ g_HNF4A*H_SREBF1_HNF4A*H_HNF4A_HNF4A*H_HNF1A_HNF4A - k_HNF4A*protein_array(1);
    g_HNF1A*H_HNF4A_HNF1A*H_HNF1A_HNF1A - k_HNF1A*protein_array(2);
    g_PPARG*H_HNF1A_PPARG*H_SREBF1_PPARG*H_PPARG_PPARG*H_INPUT_PPARG - k_PPARG*protein_array(3);
    g_SREBF1*H_PPARG_SREBF1*H_SREBF1_SREBF1 - k_SREBF1*protein_array(4);
];

% --------------------------------------------------------------------------
function [tspan,y0,options] = init
handles = feval(equations_pparg);
y0=[0,0,0,0];
