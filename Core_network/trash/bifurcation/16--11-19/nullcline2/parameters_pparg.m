function [x,v,s,h,f] = parameters_pparg
...
%%
ap = 1; %describes the index of parameter for which the bifurcation is drawn using the init_EP_EP function.
