...
## Paths
path_to_codes_folder="/media/csb/D/NAFLD/Randomization/codes"
path_to_list_of_topo_files="./../list_of_topo_files/list_of_topo_files_set.txt"
path_to_topo_file_folder="./../topo_files/"
path_to_RACIPE_output_folder="/media/csb/D/NAFLD/Randomization/RACIPE_output/"
...
#############################
	...
	$path_to_RACIPE $network_identifier.topo -num_paras $num_of_parameters -seed 1 -num_stability 4 & 
...
#############################
	...
	cp $path_to_topo_file $path_to_run_folder
	cd $path_to_run_folder
	$path_to_RACIPE $network_identifier.topo -num_paras $num_of_parameters -seed 2 -num_stability 4 & 
        cd $path_to_codes_folder
...
#############################
	...
	cp $path_to_topo_file $path_to_run_folder
	cd $path_to_run_folder
	$path_to_RACIPE $network_identifier.topo -num_paras $num_of_parameters -seed 3 -num_stability 4
        cd $path_to_codes_folder
